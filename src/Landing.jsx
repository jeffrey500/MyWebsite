    ...
    return(
        <section className="h-screen items-center justify-center">
            ...
            <div className="relative h-full overflow-hidden">
                ...
                <div
                    className="relative z-10 flex flex-col h-full items-center justify-center -translate-x-8 translate-y-10">

                    <div
                        className="flex flex-row items-center justify-center translate-y-10 text-4xl text-[#7e8ea7] font-bold">
                        <a href={"#projects"}>
                            <div
                                className="relative bg-blue-200 rounded-xl p-4 -translate-x-15 shadow-xl hover:bg-blue-300 duration-500">Projects
                            </div>
                        </a>

                        <a href={"#contact"}>
                            <div
                                className="relative bg-blue-200 rounded-xl p-4 translate-x-15 shadow-xl hover:bg-blue-300 duration-500">Contact
                            </div>
                        </a>
                    </div>
