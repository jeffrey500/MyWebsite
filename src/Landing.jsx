        ...
        <section className="h-screen items-center justify-center">
            <div className="relative h-full overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col h-full items-center justify-center translate-x-10 translate-y-5">
                    <div className="relative bg-gray-300 rounded-xl p-5 text-5xl shadow-xl">
                    ...
                    <div className="flex flex-row items-center justify-center translate-y-10 text-4xl text-[#7e8ea7] font-bold">
                        <a href={"#projects"}>
                            <div className="relative bg-blue-200 rounded-xl p-3 -translate-x-15 shadow-xl">Projects</div>
                        </a>

                        <a href={"#contact"}>
                            <div className="relative bg-blue-200 rounded-xl p-3 translate-x-15 shadow-xl">Contact</div>
                        </a>
                    </div>
